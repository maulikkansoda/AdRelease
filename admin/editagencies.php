...
$req = $con->query("select * from company where Agency_id='$editid'");
...
if(isset($_POST["submit"]))
{
  ...
  $password      = $_POST["password"];
    ...
    $exe =$con->query("update company set Agency_name='$aname',Email='$email',Contact='$contact',Owner_name='$oname',Address='$address',City='$city',State='$state',Password='$password' where Agency_id='$editid' ");
							...
							<div class="col-xs-12">
								...
								<form method="post" class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > Agency Name </label>

										<div class="col-sm-9">
											<input type="text" name="agencyname" id="form-field-1" placeholder=" Enter Agency Name " class="col-xs-10 col-sm-5" value="<?php echo $row->Agency_name;?>" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="email" id="form-field-1" placeholder="Enter Email" class="col-xs-10 col-sm-5" value="<?php echo $row->Email;?>" required />
										</div>
									</div>
										...
										<div class="col-sm-9">
											<input type="text" name="contact" id="form-field-1" placeholder="Enter Contact" class="col-xs-10 col-sm-5" value="<?php echo $row->Contact;?>"  required pattern="[0-9]{10}" title="must be 10 digit"/>
										</div>
									</div>
										...
										<div class="col-sm-9">
											<input type="text" name="ownername" id="form-field-1" placeholder="Enter OwnerName" class="col-xs-10 col-sm-5" value="<?php echo $row->Owner_name;?>" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="address" placeholder="Address" class="col-xs-10 col-sm-5" required><?php echo $row->Address;?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="city" id="form-field-1" placeholder="Enter City" class="col-xs-10 col-sm-5" value="<?php echo $row->City;?>" required />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5" name="state" value="<?php echo $row->State;?>" required>
						                        ...
						                        <option value="Kerala" <?php if($state=='Kerala') echo 'selected';?>>KeralaKerala</option>   
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="Password" name="password" id="form-field-1" placeholder="Enter Password" class="col-xs-10 col-sm-5" value="<?php echo $row->Password;?>" required />
										</div>
									</div>
